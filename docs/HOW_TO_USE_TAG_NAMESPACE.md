...
RoutesToSwaggerDocs.configure do |config|
   ...
   config.tag_use_namespace = true   # write here
 end
```
...
RoutesToSwaggerDocs.configure do |config|
   ...
   config.schema_save_dir_name = "shemas"
   config.doc_save_file_name = "swagger_doc.yml"
   config.tag_use_namespace = false # write here
end
```
...
<img alt="swagger_ui" src="https://user-images.githubusercontent.com/11146767/56959949-375cd380-6b8a-11e9-9cd7-aae79f601205.png" width="546">
